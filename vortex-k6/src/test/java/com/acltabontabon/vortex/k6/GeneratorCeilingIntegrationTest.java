...
class GeneratorCeilingIntegrationTest {
    ...
    private EffectiveTestPlan clampedTo(int maxVirtualUsers) {
        ...
        return new EffectiveTestPlan(base.id(), base.projectId(), base.projectName(),
                ...
                new com.acltabontabon.vortex.core.target.ExternalEndpointTarget(
                        com.acltabontabon.vortex.core.environment.TargetUrl.of(targetUrl())),
                com.acltabontabon.vortex.core.environment.TargetUrl.of(targetUrl()),
                com.acltabontabon.vortex.core.environment.TargetUrl.of(targetUrl()),
    ...
    private PerformanceEngine.EngineOutcome run(EffectiveTestPlan plan, Path workspace) {
        ...
        return engine.execute(ExecutionId.of("ceiling"), plan,
                com.acltabontabon.vortex.core.target.ResourceEnvelopeRequest.none(), _ -> { },
