...
public record PerformanceEvidence(
        ...
        com.acltabontabon.vortex.core.capacity.ProductionObservation production) {
    ...
    public Optional<com.acltabontabon.vortex.core.capacity.ProductionObservation> productionIfPresent() {
    ...
    public java.util.List<String> baselineQuality() {
        return productionIfPresent()
                .map(com.acltabontabon.vortex.core.capacity.ProductionObservation::qualityFacts)
