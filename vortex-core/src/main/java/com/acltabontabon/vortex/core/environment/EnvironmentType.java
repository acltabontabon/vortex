...
public enum EnvironmentType {
     ...
     */
    public com.acltabontabon.vortex.core.shared.Concurrency defaultConcurrencyCeiling() {
        return com.acltabontabon.vortex.core.shared.Concurrency.of(Math.max(1, (int) Math.round(defaultRateCeiling / 10)));
    }
}
