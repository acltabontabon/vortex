...
public interface DatasetStore {
     ...
     *
     * @throws com.acltabontabon.vortex.core.data.DatasetException with per-row problems when it cannot be parsed
     */
     ...
     *
     * @throws com.acltabontabon.vortex.core.data.DatasetException when it is absent or no longer parses
     */
