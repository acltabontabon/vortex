 ...
 *                    {@link dev.vortex.core.analysis.EvidenceIds#DELTA} this is what an AI
 *                    interpretation of a comparison must cite, the same discipline {@link
 *                    dev.vortex.core.analysis.EvidenceIds} already applies to single-run metrics
...
public record MetricDelta(
    ...
    public String evidenceId() {
        return dev.vortex.core.analysis.EvidenceIds.delta(metricId);
    }
