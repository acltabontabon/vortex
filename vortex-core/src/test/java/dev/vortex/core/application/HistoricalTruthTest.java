...
class HistoricalTruthTest {
    ...
    private EffectiveTestPlan resolve(dev.vortex.core.project.ProjectConfiguration configuration,
            String workloadName) {
    ...
    void changingTheRateDoesNotRewriteAFinishedRun() {
        ...
        var edited = Fixtures.workload("average-load",
                dev.vortex.core.workload.TestType.AVERAGE_LOAD, Fixtures.operationMix(),
    ...
    void deletingTheWorkloadLeavesTheRunIntact() {
        ...
        assertThat(plan.testType()).isEqualTo(dev.vortex.core.workload.TestType.AVERAGE_LOAD);
