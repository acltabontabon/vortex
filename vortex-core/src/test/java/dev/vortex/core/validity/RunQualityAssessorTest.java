...
class RunQualityAssessorTest {
    ...
    class Independence {
        ...
        void passingAndInvalid() {
            ...
            var verdict = new dev.vortex.core.threshold.ThresholdEvaluator()
                    .evaluate(Fixtures.thresholds(), invalid).overall();

            assertThat(verdict).isEqualTo(dev.vortex.core.threshold.Verdict.PASS);
            assertThat(assessment.quality()).isEqualTo(RunQuality.INVALID);
        }
        ...
        void failingAndValid() {
            ...
            assertThat(verdict).isEqualTo(dev.vortex.core.threshold.Verdict.FAIL);
