...
import dev.vortex.core.comparison.DeltaKind;
    ...
    class Comparison {
        ...
        void differingCoverageIsStatedRatherThanScoredAsARegression() {
            ...
            MeasuredResults withTelemetry = new MeasuredResults(observed.window(),
                    ...
                    List.of(dev.vortex.core.metrics.MetricObservation.of("metric:cpu", "CPU",
                            dev.vortex.core.metrics.MetricSource.PROMETHEUS,
                            dev.vortex.core.metrics.MetricUnit.PERCENT,
                            dev.vortex.core.metrics.Aggregation.MAX, 41, observed.window())),
