...
import com.acltabontabon.vortex.core.fixtures.FakePerformanceEngine;
 ...
 * {@code targetProbe}-based HTTP check ({@link com.acltabontabon.vortex.core.target.ExternalEndpointTarget}, wired
...
class PreflightServiceTest {
    ...
    private static final class FakeTargetExecutor implements TargetExecutor {
        ...
        @Override
        public com.acltabontabon.vortex.core.target.PreparedTarget prepare(
                com.acltabontabon.vortex.core.target.TargetPreparationRequest request) {
