...
class GlobalRunsApiControllerTest {
    ...
    class Compare {
        ...
        void sameExperimentSupportsAVerdict() throws Exception {
            ...
            var comparison = new com.acltabontabon.vortex.core.comparison.RegressionEvaluator()
                    .compare(baseline, candidate);
            var verdict = new com.acltabontabon.vortex.core.comparison.RegressionEvaluator().evaluate(comparison);
