...
import com.acltabontabon.vortex.app.adapter.lab.DockerLocalLab;
import com.acltabontabon.vortex.app.adapter.observability.ActuatorObservabilityProvider;
import com.acltabontabon.vortex.app.adapter.probe.HttpTargetProbe;
import com.acltabontabon.vortex.app.adapter.process.ShutdownProcessRegistry;
import com.acltabontabon.vortex.app.adapter.target.docker.DockerCapabilityProbe;
import com.acltabontabon.vortex.app.adapter.target.docker.DockerComposeTargetExecutor;
import com.acltabontabon.vortex.app.adapter.target.docker.DockerImageTargetExecutor;
import com.acltabontabon.vortex.app.adapter.target.docker.DockerProcess;
import com.acltabontabon.vortex.app.adapter.target.docker.SocketTargetReadinessProbe;
...
import com.acltabontabon.vortex.k6.DockerK6Runner;
import com.acltabontabon.vortex.k6.K6PerformanceEngine;
import com.acltabontabon.vortex.k6.K6RawMetricsAggregator;
import com.acltabontabon.vortex.k6.K6Runner;
import com.acltabontabon.vortex.k6.K6ScriptGenerator;
import com.acltabontabon.vortex.k6.K6SummaryParser;
import com.acltabontabon.vortex.openapi.OpenApiCatalogImporter;
...
public class EngineConfiguration {
    ...
    K6Runner k6Runner(VortexProperties properties, ShutdownProcessRegistry processes) {
        ...
        return engine.usesDocker()
                ...
                : new com.acltabontabon.vortex.k6.LocalBinaryK6Runner(engine.executable(), processes::track);
    }
    ...
    ObservabilityProvider prometheusObservabilityProvider(RestClient.Builder builder,
            VortexProperties properties) {
        return new com.acltabontabon.vortex.app.adapter.observability.PrometheusObservabilityProvider(
    ...
    ObservabilityProvider dynatraceObservabilityProvider(RestClient.Builder builder,
            VortexProperties properties) {
        return new com.acltabontabon.vortex.app.adapter.observability.DynatraceObservabilityProvider(
     ...
     */
    @Bean
    com.acltabontabon.vortex.app.adapter.observability.LoadGeneratorObservabilityProvider loadGeneratorObserver(
            VortexProperties properties) {
        ...
        return new com.acltabontabon.vortex.app.adapter.observability.LoadGeneratorObservabilityProvider(
    ...
    ResourceSampleSinkFactory resourceSampleSinkFactory(ArtifactStore artifacts) {
        return new com.acltabontabon.vortex.app.adapter.observability.ArtifactResourceSampleSinkFactory(artifacts);
    }
    ...
    ResourceTelemetryReader resourceTelemetryReader(ArtifactStore artifacts) {
        return new com.acltabontabon.vortex.app.adapter.observability.ArtifactResourceTelemetryReader(artifacts);
    }
    ...
    TelemetryCollector telemetryCollector(List<ObservabilityProvider> providers,
            com.acltabontabon.vortex.app.adapter.observability.LoadGeneratorObservabilityProvider generator,
        ...
        return new com.acltabontabon.vortex.app.adapter.observability.ObservabilityTelemetryCollector(
    ...
    /**
     * The {@link TargetExecutor} for {@link com.acltabontabon.vortex.core.target.DockerImageTarget} — one more
     * bean added to the list {@code ExecutionService} already collects, the same shape as {@link
     * com.acltabontabon.vortex.app.config.CoreConfiguration}'s {@code externalEndpointTargetExecutor}.
     */
    @Bean
    ...
    /**
     * The {@link TargetExecutor} for {@link com.acltabontabon.vortex.core.target.DockerComposeTarget} — attach-only,
