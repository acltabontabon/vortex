...
import com.acltabontabon.vortex.core.safety.SafetyAssessment;
...
public record PreflightReport(
    ...
    public String plainEnglishSummary() {
        ...
        if (plan.workloadModel() == com.acltabontabon.vortex.core.workload.WorkloadModel.OPEN) {
        ...
        text.append(com.acltabontabon.vortex.core.threshold.Durations.display(plan.totalDuration()))
                .append(" against ")
