package com.acltabontabon.vortex.core.architecture;
 ...
 */
@AnalyzeClasses(
        packages = "com.acltabontabon.vortex.core",
...
class CoreArchitectureTest {
    ...
    static final ArchRule domain_does_not_depend_on_persistence_technology =
            noClasses().should().dependOnClassesThat()
                    ...
                    .because("""
                            ...
                            repository ports in com.acltabontabon.vortex.core.port.""");

    @ArchTest
    static final ArchRule domain_does_not_depend_on_the_execution_engine =
            noClasses().should().dependOnClassesThat().resideInAnyPackage("io.k6..", "com.acltabontabon.vortex.k6..")
                    .because("""
    ...
    static final ArchRule domain_does_not_depend_on_the_ai_provider =
            noClasses().should().dependOnClassesThat()
                    .resideInAnyPackage("org.springframework.ai..", "com.acltabontabon.vortex.ai..")
                    .because("""
    ...
    static final ArchRule domain_does_not_read_the_clock_directly =
            noClasses().that().resideOutsideOfPackage("com.acltabontabon.vortex.core.port..")
    ...
    static final ArchRule the_reasoning_model_names_no_transport =
            noClasses().that().resideInAnyPackage(
                            "com.acltabontabon.vortex.core.metrics..",
                            "com.acltabontabon.vortex.core.analysis..",
                            "com.acltabontabon.vortex.core.resource..",
                            "com.acltabontabon.vortex.core.validity..",
                            "com.acltabontabon.vortex.core.capacity..")
