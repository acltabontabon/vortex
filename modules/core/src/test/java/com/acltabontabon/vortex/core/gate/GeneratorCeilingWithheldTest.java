...
class GeneratorCeilingWithheldTest {
     ...
     */
    private static com.acltabontabon.vortex.core.plan.EffectiveTestPlan askingFor(RequestsPerSecond level) {
        return Fixtures.plan(com.acltabontabon.vortex.core.workload.TestType.AVERAGE_LOAD,
                new com.acltabontabon.vortex.core.workload.RampingArrivalRateShape(RequestsPerSecond.of(10),
                        List.of(new com.acltabontabon.vortex.core.workload.Stage(level, Duration.ofMinutes(1)),
                                new com.acltabontabon.vortex.core.workload.Stage(level, Duration.ofMinutes(10)))));
    }
    ...
    void headroomIsRefused() {
        ...
        var headroom = new HeadroomCalculator().calculate(result, true,
                com.acltabontabon.vortex.core.capacity.BoundaryStatus.ESTABLISHED, null);
