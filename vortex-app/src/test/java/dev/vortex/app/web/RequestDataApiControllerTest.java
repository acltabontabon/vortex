...
class RequestDataApiControllerTest {
    ...
    class Saving {
        ...
        private dev.vortex.core.catalog.OperationBinding savedBinding() {
    ...
    class Datasets {
        ...
        void unreadableDatasetsAreStillListed() throws Exception {
            ...
            when(datasets.read(any(), any())).thenThrow(new dev.vortex.core.data.DatasetException(
                    "broken", List.of(new dev.vortex.core.data.DatasetProblem("column 'id'",
