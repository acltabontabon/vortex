...
import dev.vortex.ai.OllamaPerformanceAssistant;
...
public class AiConfiguration {
    ...
    private record UnconfiguredAssistant(AiSettings settings) implements PerformanceAssistant {
        ...
        public java.util.Optional<String> explainWorkload(
                dev.vortex.core.capacity.ProductionObservation observation,
                java.util.List<String> calculatedSuggestions) {
            return java.util.Optional.empty();
        }

        @Override
        public dev.vortex.core.analysis.Analysis analyze(dev.vortex.core.shared.ExecutionId executionId,
                dev.vortex.core.plan.EffectiveTestPlan plan,
                dev.vortex.core.analysis.DeterministicSummary summary) {
            return dev.vortex.core.analysis.Analysis.failed(
                    dev.vortex.core.shared.AnalysisId.generate(), executionId,
        ...
        public ComparisonAnalysis compareExecutions(TestExecution baseline, TestExecution candidate,
            ...
            return ComparisonAnalysis.failed(dev.vortex.core.shared.AnalysisId.generate(),
