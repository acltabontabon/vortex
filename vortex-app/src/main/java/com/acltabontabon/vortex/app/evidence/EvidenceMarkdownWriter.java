...
import com.acltabontabon.vortex.core.evidence.FindingLevel;
...
public final class EvidenceMarkdownWriter {
    ...
    private void sparkline(StringBuilder out, String label,
            com.acltabontabon.vortex.core.evidence.SeriesPlot plot, int columns) {
        if (!plot.hasData()) {
            return;
        }
        ...
        out.append("`").append(String.format(Locale.ROOT, "%-11s", label)).append(new String(line))
                .append("` 0–").append(com.acltabontabon.vortex.core.evidence.SeriesPlot
