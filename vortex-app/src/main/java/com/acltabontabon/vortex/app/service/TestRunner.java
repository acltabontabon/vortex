...
import com.acltabontabon.vortex.app.evidence.EvidenceJsonWriter;
import com.acltabontabon.vortex.app.evidence.EvidenceMarkdownWriter;
...
public class TestRunner {
    ...
    public EffectiveTestPlan resolve(ProjectId projectId, String workloadName, String environmentName,
        ...
        var catalog = projects.catalog(projectId)
                .orElseGet(com.acltabontabon.vortex.core.catalog.ServiceCatalog::empty);
        ...
        if (provisional.isPresent()
                && provisional.get().target() instanceof com.acltabontabon.vortex.core.target.ExternalEndpointTarget) {
     ...
     */
    private record EffectiveTestPlanProbe(com.acltabontabon.vortex.core.environment.Environment environment) {
        ...
        EffectiveTestPlan plan() {
            ...
            com.acltabontabon.vortex.core.environment.TargetUrl endpoint =
                    ((com.acltabontabon.vortex.core.target.ExternalEndpointTarget) environment.target()).endpoint();
            return new EffectiveTestPlan(
                    com.acltabontabon.vortex.core.shared.TestPlanId.generate(),
                    com.acltabontabon.vortex.core.shared.ProjectId.generate(), "", "",
                    TestIntent.defaultFor(com.acltabontabon.vortex.core.workload.TestType.SMOKE), "", "",
                    com.acltabontabon.vortex.core.workload.TestType.SMOKE,
                    com.acltabontabon.vortex.core.workload.WorkloadModel.OPEN,
                    com.acltabontabon.vortex.core.shared.RequestsPerSecond.of(1), List.of(), List.of(), List.of(),
                    com.acltabontabon.vortex.core.workload.WorkloadSource.manual(),
                    com.acltabontabon.vortex.core.threshold.ThresholdSet.empty(), environment.name(),
                    ...
                    com.acltabontabon.vortex.core.validity.ValidityPolicy.defaults(), "");
        }
    }
}
